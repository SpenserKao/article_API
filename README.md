...
## _Abstract_
For the technical test on an set of article API, this document outlines its requirements, and the design, development environment, execution, test for its implementation. Last but not the least, Wishlist outlines what can be improved, time permitting.<br/> <br/>
