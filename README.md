...
## _Abstract_
For the technical test on *article API*, this document outlines its requirements, design, development environment, setup/installation, execution and test. Maintenance wise, some parameters, eventhough likely less frequently changed, have been moved to configuration. Last but not the least, Wishlist outlines what can be improved, time permitting.<br/> <br/>
